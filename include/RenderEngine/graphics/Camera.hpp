...
namespace RenderEngine
{
    ...
    public:
        ...
        ~Camera();
    protected:
        Camera(float horizontal_length, float near_plane_distance, float far_plane_distance,
    ...
    public:
        ...
        PerspectiveCamera(float horizontal_field_of_view, float near_plane_distance, float far_plane_distance,
                          Vector position = {0., 0., 0.}, Quaternion orientation = {}, double scale=1.0, Referential* parent = nullptr);
        ~PerspectiveCamera();
    };
    ...
    public:
        ...
        OrthographicCamera(float horizontal_length, float far_plane_distance,
                           Vector position = {0., 0., 0.}, Quaternion orientation = {}, double scale=1.0, Referential* parent = nullptr);
        ~OrthographicCamera();
    };
}