...
Mesh Mesh::cube(const std::shared_ptr<GPU>& gpu, float r)
{
    ...
    std::vector<Face> faces = {Face({{{0., 0., 0.}, {r, r, 0.}, {0., r, 0.}}}, {1., 0., 0., 1.}),
                               ...
                               Face({{{0., 0., r}, {0., r, r}, {r, r, r}}}, {1., 1., 0., 1.}),
                               Face({{{0., 0., r}, {r, r, r}, {r, 0., r}}}, {1., 1., 0., 1.}),

                               Face({{{0., 0., 0.}, {r, 0., r}, {r, 0., 0.}}}, {1., 0., 1., 1.}),
                               Face({{{0., 0., 0.}, {0., 0., r}, {r, 0., r}}}, {1., 0., 1., 1.}),
                               Face({{{0., r, 0.}, {r, r, 0.}, {r, r, r}}}, {0., 0., 1., 1.}),
                               Face({{{0., r, 0.}, {r, r, r}, {0., r, r}}}, {0., 0., 1., 1.}),
                               
                               Face({{{0., 0., 0.}, {0., r, r}, {0., 0., r}}}, {0., 1., 1., 1.}),
                               Face({{{0., 0., 0.}, {0., r, 0.}, {0., r, r}}}, {0., 1., 1., 1.}),
